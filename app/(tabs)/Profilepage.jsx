...
const Profilepage = () => {
  ...
  const handleSave = async () => {
    await updateProfile(user._id, name, country, selectedColor, userImage);
  };
  ...
  const pickImage = async () => {
    ...
    if (!result.canceled) {
      ...
      await addProfileImg(user._id, result);
    }
  };
  ...
  return (
    <LinearGradient colors={['#006400', '#004d00']} style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <TextInput style={styles.input} value={email} onChangeText={setEmail} placeholder="Email" placeholderTextColor="#666" editable={false} />
        <TextInput style={styles.input} value={name} onChangeText={setName} placeholder="Name" placeholderTextColor="#fff" />
...
const styles = StyleSheet.create({
  ...
  pickerContainer: { backgroundColor: '#2C3137', borderRadius: 5, marginBottom: 10 },
  picker: { color: '#fff' },
